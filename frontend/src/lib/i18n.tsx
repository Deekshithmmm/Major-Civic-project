...
const STRINGS = {
  ...
  stationAddress: { en: 'Address', hi: 'पता', kn: 'ವಿಳಾಸ' },
  stationWard: { en: 'Ward', hi: 'वार्ड', kn: 'ವಾರ್ಡ್' },
  stationSho: { en: 'Station head', hi: 'थाना प्रभारी', kn: 'ಠಾಣಾ ಮುಖ್ಯಸ್ಥ' },
  stationPhone: { en: 'Phone', hi: 'फ़ोन', kn: 'ಫೋನ್' },
  stationEmergency: { en: 'Emergency', hi: 'आपातकाल', kn: 'ತುರ್ತು' },
  stationViewAll: { en: 'View full details', hi: 'पूरी जानकारी देखें', kn: 'ಪೂರ್ಣ ವಿವರ ನೋಡಿ' },
  stationFlagged: { en: 'Past FIR deadline', hi: 'FIR की समय-सीमा बीत चुकी', kn: 'FIR ಗಡುವು ಮೀರಿದೆ' },
  stationResponseTitle: { en: 'How this station responds', hi: 'यह थाना कैसे प्रतिक्रिया देता है', kn: 'ಈ ಠಾಣೆ ಹೇಗೆ ಸ್ಪಂದಿಸುತ್ತದೆ' },
  stationResponseIntro: {
    en: 'Counted from the station’s own register. Crime reports and their evidence are never published here — only how quickly this station acts on what it receives.',
    hi: 'थाने के अपने रजिस्टर से गिना गया। अपराध की शिकायतें और उनके साक्ष्य यहाँ कभी प्रकाशित नहीं होते — केवल यह कि थाना कितनी जल्दी कार्रवाई करता है।',
    kn: 'ಠಾಣೆಯ ಸ್ವಂತ ರಿಜಿಸ್ಟರ್‌ನಿಂದ ಎಣಿಸಲಾಗಿದೆ. ಅಪರಾಧ ದೂರುಗಳು ಮತ್ತು ಅವುಗಳ ಸಾಕ್ಷ್ಯ ಇಲ್ಲಿ ಎಂದಿಗೂ ಪ್ರಕಟವಾಗುವುದಿಲ್ಲ — ಠಾಣೆ ಎಷ್ಟು ಬೇಗ ಕ್ರಮ ಕೈಗೊಳ್ಳುತ್ತದೆ ಎಂಬುದು ಮಾತ್ರ.',
  },
  stationReports30: { en: 'Reports (30 days)', hi: 'शिकायतें (30 दिन)', kn: 'ದೂರುಗಳು (30 ದಿನ)' },
  stationReports90: { en: 'Reports (90 days)', hi: 'शिकायतें (90 दिन)', kn: 'ದೂರುಗಳು (90 ದಿನ)' },
  stationUnack: { en: 'Unacknowledged past 24h', hi: '24 घंटे बाद भी अस्वीकृत', kn: '24 ಗಂಟೆ ಮೀರಿ ಸ್ವೀಕರಿಸದ' },
  stationFirs: { en: 'FIRs registered', hi: 'दर्ज FIR', kn: 'ದಾಖಲಾದ FIR' },
  stationConversion: { en: 'FIR conversion', hi: 'FIR रूपांतरण', kn: 'FIR ಪರಿವರ್ತನೆ' },
  stationMedianAck: { en: 'Median time to acknowledge', hi: 'स्वीकृति का औसत समय', kn: 'ಸ್ವೀಕರಿಸಲು ಸರಾಸರಿ ಸಮಯ' },
  stationPastFirSla: { en: 'Open past 7 days, no FIR', hi: '7 दिन बाद भी बिना FIR', kn: '7 ದಿನ ಮೀರಿ FIR ಇಲ್ಲದೆ' },
  stationClosedNoFir: { en: 'Closed without FIR', hi: 'बिना FIR बंद', kn: 'FIR ಇಲ್ಲದೆ ಮುಚ್ಚಲಾಗಿದೆ' },
  stationNotShownTitle: { en: 'What this page never shows', hi: 'यह पेज कभी क्या नहीं दिखाता', kn: 'ಈ ಪುಟ ಎಂದಿಗೂ ಏನು ತೋರಿಸುವುದಿಲ್ಲ' },
  stationNotShownBody: {
    en: 'No case details, no names, no footage. Sexual offence and child cases are excluded even from these counts.',
    hi: 'कोई मामला विवरण नहीं, कोई नाम नहीं, कोई फ़ुटेज नहीं। यौन अपराध और बच्चों से जुड़े मामले इन संख्याओं से भी बाहर रखे गए हैं।',
  ...
  grievanceNav: { en: 'Object to a report', hi: 'शिकायत पर आपत्ति', kn: 'ವರದಿಗೆ ಆಕ್ಷೇಪಣೆ' },
  grievanceTitle: { en: 'Grievance Officer', hi: 'शिकायत निवारण अधिकारी', kn: 'ಕುಂದುಕೊರತೆ ಅಧಿಕಾರಿ' },
  grievanceIntro: {
    en: 'If something published here is wrong about you or your office, this is how you get it corrected or removed. You do not need an account, and you do not need a lawyer.',
    hi: 'यदि यहाँ प्रकाशित कोई बात आपके या आपके कार्यालय के बारे में गलत है, तो उसे सुधारने या हटाने का यही रास्ता है। न खाता चाहिए, न वकील।',
    kn: 'ಇಲ್ಲಿ ಪ್ರಕಟವಾದ ಯಾವುದಾದರೂ ನಿಮ್ಮ ಅಥವಾ ನಿಮ್ಮ ಕಚೇರಿಯ ಬಗ್ಗೆ ತಪ್ಪಾಗಿದ್ದರೆ, ಅದನ್ನು ಸರಿಪಡಿಸಲು ಅಥವಾ ತೆಗೆದುಹಾಕಲು ಇದೇ ಮಾರ್ಗ. ಖಾತೆಯೂ ಬೇಡ, ವಕೀಲರೂ ಬೇಡ.',
  },
  grievanceOfficerLabel: { en: 'Write to', hi: 'यहाँ लिखें', kn: 'ಇಲ್ಲಿಗೆ ಬರೆಯಿರಿ' },
  grievanceAddress: { en: 'Address', hi: 'पता', kn: 'ವಿಳಾಸ' },
  grievanceAckClock: { en: 'Acknowledged within', hi: 'पावती इतने समय में', kn: 'ಇಷ್ಟರೊಳಗೆ ಸ್ವೀಕೃತಿ' },
  grievanceResolveClock: { en: 'Decided within', hi: 'निर्णय इतने समय में', kn: 'ಇಷ್ಟರೊಳಗೆ ನಿರ್ಧಾರ' },
  grievanceHours: { en: 'hours', hi: 'घंटे', kn: 'ಗಂಟೆಗಳು' },
  grievanceDays: { en: 'days', hi: 'दिन', kn: 'ದಿನಗಳು' },
  grievanceRuleNote: {
    en: 'These two deadlines come from Rule 3(2) of the IT Rules 2021. How well they are actually kept is published below, not just promised.',
    hi: 'ये दोनों समय-सीमाएँ आईटी नियम 2021 के नियम 3(2) से हैं। इनका वास्तव में कितना पालन हुआ, यह नीचे प्रकाशित है — केवल वादा नहीं।',
    kn: 'ಈ ಎರಡು ಗಡುವುಗಳು ಐಟಿ ನಿಯಮ 2021ರ ನಿಯಮ 3(2)ರಿಂದ ಬಂದವು. ಅವನ್ನು ನಿಜಕ್ಕೂ ಎಷ್ಟು ಪಾಲಿಸಲಾಗಿದೆ ಎಂಬುದು ಕೆಳಗೆ ಪ್ರಕಟವಾಗಿದೆ — ಬರೀ ಭರವಸೆಯಲ್ಲ.',
  },
  grievanceComplianceTitle: { en: 'Our own record', hi: 'हमारा अपना रिकॉर्ड', kn: 'ನಮ್ಮದೇ ದಾಖಲೆ' },
  grievanceComplianceIntro: {
    en: 'The same test this platform applies to a police station, applied to itself. Counts only: no complaint and no complainant appears here.',
    hi: 'जो कसौटी यह प्लेटफ़ॉर्म थाने पर लगाता है, वही अपने पर भी। केवल संख्याएँ: यहाँ न कोई शिकायत दिखती है, न शिकायतकर्ता।',
    kn: 'ಈ ವೇದಿಕೆ ಠಾಣೆಗೆ ಅನ್ವಯಿಸುವ ಅದೇ ಮಾನದಂಡ, ತನಗೂ. ಎಣಿಕೆಗಳಷ್ಟೇ: ಇಲ್ಲಿ ದೂರೂ ಕಾಣಿಸದು, ದೂರುದಾರರೂ ಕಾಣಿಸರು.',
  },
  grievanceReceived: { en: 'Grievances received', hi: 'प्राप्त शिकायतें', kn: 'ಸ್ವೀಕರಿಸಿದ ಕುಂದುಕೊರತೆಗಳು' },
  grievanceAckMissed: { en: 'Acknowledgement missed', hi: 'पावती छूटी', kn: 'ಸ್ವೀಕೃತಿ ತಪ್ಪಿದೆ' },
  grievanceOnTime: { en: 'Decided on time', hi: 'समय पर निर्णय', kn: 'ಸಮಯಕ್ಕೆ ನಿರ್ಧಾರ' },
  grievanceOverdue: { en: 'Open past deadline', hi: 'समय-सीमा पार, लंबित', kn: 'ಗಡುವು ಮೀರಿ ಬಾಕಿ' },
  grievanceUpheld: { en: 'Upheld (content removed)', hi: 'स्वीकृत (सामग्री हटाई)', kn: 'ಅಂಗೀಕೃತ (ವಿಷಯ ತೆಗೆದಿದೆ)' },
  grievanceRejected: { en: 'Rejected (content stayed)', hi: 'अस्वीकृत (सामग्री बनी रही)', kn: 'ತಿರಸ್ಕೃತ (ವಿಷಯ ಉಳಿದಿದೆ)' },

  grievanceTrackTitle: { en: 'Check a ticket', hi: 'टिकट देखें', kn: 'ಟಿಕೆಟ್ ಪರಿಶೀಲಿಸಿ' },
  grievanceTicketLabel: { en: 'Ticket number', hi: 'टिकट नंबर', kn: 'ಟಿಕೆಟ್ ಸಂಖ್ಯೆ' },
  grievanceTicketHelp: {
    en: 'The 8-digit number you were given when you filed. It shows the status only — never your complaint or your details.',
    hi: 'शिकायत दर्ज करते समय मिला 8 अंकों का नंबर। यह केवल स्थिति दिखाता है — आपकी शिकायत या आपका विवरण कभी नहीं।',
    kn: 'ದೂರು ದಾಖಲಿಸಿದಾಗ ನಿಮಗೆ ಸಿಕ್ಕ 8 ಅಂಕಿಯ ಸಂಖ್ಯೆ. ಇದು ಸ್ಥಿತಿಯನ್ನಷ್ಟೇ ತೋರಿಸುತ್ತದೆ — ನಿಮ್ಮ ದೂರು ಅಥವಾ ವಿವರಗಳನ್ನು ಎಂದಿಗೂ ಅಲ್ಲ.',
  },
  grievanceNotFound: { en: 'No grievance with that ticket.', hi: 'इस टिकट पर कोई शिकायत नहीं।', kn: 'ಆ ಟಿಕೆಟ್‌ನ ಕುಂದುಕೊರತೆ ಇಲ್ಲ.' },
  grievanceDueBy: { en: 'Decision due by', hi: 'निर्णय की अंतिम तिथि', kn: 'ನಿರ್ಧಾರದ ಕೊನೆಯ ದಿನಾಂಕ' },
  grievanceDecision: { en: 'Decision', hi: 'निर्णय', kn: 'ನಿರ್ಧಾರ' },
  grievancePastDue: { en: 'Past the deadline', hi: 'समय-सीमा पार', kn: 'ಗಡುವು ಮೀರಿದೆ' },

  respondTitle: { en: 'Respond to this report', hi: 'इस शिकायत का उत्तर दें', kn: 'ಈ ವರದಿಗೆ ಪ್ರತಿಕ್ರಿಯಿಸಿ' },
  respondIntro: {
    en: 'Two different things. A reply is published under the report and leaves it standing. A grievance asks for the report to be corrected or removed.',
    hi: 'दो अलग बातें। उत्तर शिकायत के नीचे प्रकाशित होता है और शिकायत बनी रहती है। आपत्ति में शिकायत को सुधारने या हटाने की माँग होती है।',
    kn: 'ಎರಡು ಬೇರೆ ಬೇರೆ ವಿಷಯಗಳು. ಪ್ರತ್ಯುತ್ತರ ವರದಿಯ ಕೆಳಗೆ ಪ್ರಕಟವಾಗಿ ವರದಿ ಹಾಗೇ ಉಳಿಯುತ್ತದೆ. ಆಕ್ಷೇಪಣೆ ವರದಿಯನ್ನು ಸರಿಪಡಿಸಲು ಅಥವಾ ತೆಗೆಯಲು ಕೇಳುತ್ತದೆ.',
  },
  replyTab: { en: 'Publish a reply', hi: 'उत्तर प्रकाशित करें', kn: 'ಪ್ರತ್ಯುತ್ತರ ಪ್ರಕಟಿಸಿ' },
  grievanceTab: { en: 'Ask for removal', hi: 'हटाने की माँग', kn: 'ತೆಗೆಯಲು ಕೋರಿ' },
  replyIntro: {
    en: 'Your reply appears under the allegation, attributed to the office. Your own name and email are used only to verify the reply is genuine and are never published.',
    hi: 'आपका उत्तर आरोप के नीचे, कार्यालय के नाम से दिखता है। आपका नाम और ईमेल केवल सत्यापन के लिए हैं और कभी प्रकाशित नहीं होते।',
    kn: 'ನಿಮ್ಮ ಪ್ರತ್ಯುತ್ತರ ಆರೋಪದ ಕೆಳಗೆ, ಕಚೇರಿಯ ಹೆಸರಿನಲ್ಲಿ ಕಾಣಿಸುತ್ತದೆ. ನಿಮ್ಮ ಹೆಸರು ಮತ್ತು ಇಮೇಲ್ ಪರಿಶೀಲನೆಗಷ್ಟೇ, ಎಂದಿಗೂ ಪ್ರಕಟವಾಗುವುದಿಲ್ಲ.',
  },
  replyBody: { en: 'Your response', hi: 'आपका उत्तर', kn: 'ನಿಮ್ಮ ಪ್ರತಿಕ್ರಿಯೆ' },
  replyDepartment: { en: 'Department or office', hi: 'विभाग या कार्यालय', kn: 'ಇಲಾಖೆ ಅಥವಾ ಕಚೇರಿ' },
  replyDesignation: { en: 'Designation replying', hi: 'उत्तर देने वाला पद', kn: 'ಪ್ರತಿಕ್ರಿಯಿಸುತ್ತಿರುವ ಹುದ್ದೆ' },
  replyAuthor: { en: 'Your name (not published)', hi: 'आपका नाम (प्रकाशित नहीं)', kn: 'ನಿಮ್ಮ ಹೆಸರು (ಪ್ರಕಟವಾಗದು)' },
  replyEmail: { en: 'Official email (not published)', hi: 'आधिकारिक ईमेल (प्रकाशित नहीं)', kn: 'ಅಧಿಕೃತ ಇಮೇಲ್ (ಪ್ರಕಟವಾಗದು)' },
  replySubmit: { en: 'Submit reply', hi: 'उत्तर भेजें', kn: 'ಪ್ರತ್ಯುತ್ತರ ಕಳುಹಿಸಿ' },
  replySubmitted: {
    en: 'Reply received. A moderator verifies it came from that office before it is published.',
    hi: 'उत्तर प्राप्त हुआ। प्रकाशन से पहले मॉडरेटर सत्यापित करता है कि यह उसी कार्यालय से आया है।',
    kn: 'ಪ್ರತ್ಯುತ್ತರ ಸ್ವೀಕರಿಸಲಾಗಿದೆ. ಪ್ರಕಟಿಸುವ ಮೊದಲು ಅದು ಆ ಕಚೇರಿಯಿಂದಲೇ ಬಂದಿದೆಯೆ ಎಂದು ಮಾಡರೇಟರ್ ಪರಿಶೀಲಿಸುತ್ತಾರೆ.',
  },
  replyPublishedLabel: { en: 'Response from the office named', hi: 'संबंधित कार्यालय का उत्तर', kn: 'ಹೆಸರಿಸಲಾದ ಕಚೇರಿಯ ಪ್ರತಿಕ್ರಿಯೆ' },

  grievanceGround: { en: 'Why should this be removed?', hi: 'इसे क्यों हटाया जाए?', kn: 'ಇದನ್ನು ಏಕೆ ತೆಗೆಯಬೇಕು?' },
  groundFactuallyIncorrect: { en: 'It is factually wrong', hi: 'यह तथ्यात्मक रूप से गलत है', kn: 'ಇದು ವಾಸ್ತವವಾಗಿ ತಪ್ಪು' },
  groundIdentifiesPrivatePerson: { en: 'It identifies a private person', hi: 'इससे किसी निजी व्यक्ति की पहचान होती है', kn: 'ಇದು ಖಾಸಗಿ ವ್ಯಕ್ತಿಯನ್ನು ಗುರುತಿಸುತ್ತದೆ' },
  groundDefamatory: { en: 'It is defamatory', hi: 'यह मानहानिकारक है', kn: 'ಇದು ಮಾನಹಾನಿಕರ' },
  groundSubJudice: { en: 'The matter is before a court', hi: 'मामला न्यायालय में विचाराधीन है', kn: 'ವಿಷಯ ನ್ಯಾಯಾಲಯದ ಮುಂದಿದೆ' },
  groundNotMyDepartment: { en: 'It names the wrong office', hi: 'इसमें गलत कार्यालय का नाम है', kn: 'ಇದು ತಪ್ಪು ಕಚೇರಿಯ ಹೆಸರಿಸಿದೆ' },
  groundOther: { en: 'Something else', hi: 'कुछ और', kn: 'ಬೇರೇನೋ' },
  grievanceBody: { en: 'What is wrong with it?', hi: 'इसमें क्या गलत है?', kn: 'ಇದರಲ್ಲಿ ಏನು ತಪ್ಪಿದೆ?' },
  grievanceBodyHelp: {
    en: 'Please be specific. A reference number, a date or a document the Grievance Officer can check makes a decision much faster.',
    hi: 'कृपया स्पष्ट लिखें। कोई संदर्भ संख्या, तारीख़ या दस्तावेज़ जिसे अधिकारी जाँच सके, निर्णय बहुत तेज़ करता है।',
    kn: 'ದಯವಿಟ್ಟು ನಿರ್ದಿಷ್ಟವಾಗಿ ಬರೆಯಿರಿ. ಅಧಿಕಾರಿ ಪರಿಶೀಲಿಸಬಹುದಾದ ಉಲ್ಲೇಖ ಸಂಖ್ಯೆ, ದಿನಾಂಕ ಅಥವಾ ದಾಖಲೆ ನಿರ್ಧಾರವನ್ನು ಬಹಳ ವೇಗಗೊಳಿಸುತ್ತದೆ.',
  },
  grievanceName: { en: 'Your name', hi: 'आपका नाम', kn: 'ನಿಮ್ಮ ಹೆಸರು' },
  grievanceEmail: { en: 'Your email', hi: 'आपका ईमेल', kn: 'ನಿಮ್ಮ ಇಮೇಲ್' },
  grievanceEmailHelp: {
    en: 'Needed to send you the acknowledgement and the decision. It is shown to the Grievance Officer and to nobody else.',
    hi: 'पावती और निर्णय भेजने के लिए आवश्यक। यह केवल शिकायत निवारण अधिकारी को दिखता है, और किसी को नहीं।',
    kn: 'ಸ್ವೀಕೃತಿ ಮತ್ತು ನಿರ್ಧಾರ ಕಳುಹಿಸಲು ಅಗತ್ಯ. ಇದು ಕುಂದುಕೊರತೆ ಅಧಿಕಾರಿಗೆ ಮಾತ್ರ ಕಾಣಿಸುತ್ತದೆ, ಬೇರೆ ಯಾರಿಗೂ ಅಲ್ಲ.',
  },
  grievanceDesignation: { en: 'Your designation (optional)', hi: 'आपका पद (वैकल्पिक)', kn: 'ನಿಮ್ಮ ಹುದ್ದೆ (ಐಚ್ಛಿಕ)' },
  grievanceSubmit: { en: 'File grievance', hi: 'शिकायत दर्ज करें', kn: 'ಕುಂದುಕೊರತೆ ದಾಖಲಿಸಿ' },
  grievanceSubmitted: { en: 'Grievance filed. Keep this ticket number.', hi: 'शिकायत दर्ज। यह टिकट नंबर सुरक्षित रखें।', kn: 'ಕುಂದುಕೊರತೆ ದಾಖಲಾಗಿದೆ. ಈ ಟಿಕೆಟ್ ಸಂಖ್ಯೆ ಇಟ್ಟುಕೊಳ್ಳಿ.' },
  grievanceRespondLink: { en: 'Reply or object', hi: 'उत्तर दें या आपत्ति करें', kn: 'ಪ್ರತಿಕ್ರಿಯಿಸಿ ಅಥವಾ ಆಕ್ಷೇಪಿಸಿ' },
  grievanceWithdrawn: { en: 'This report was withdrawn', hi: 'यह शिकायत वापस ले ली गई', kn: 'ಈ ವರದಿಯನ್ನು ಹಿಂಪಡೆಯಲಾಗಿದೆ' },
} as const
